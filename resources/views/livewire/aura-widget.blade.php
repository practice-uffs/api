                                ...
                                @endif
                                    ...
                                    @if ($loggedIn == true)
                                        ...
                                        <div class="d-flex justify-content-end" style>
                                            <div>
                                                <button class="dislike" wire:click="assessAnswer('{{$message['category']}}','{{$message['userQuestion']}}',0)">
                                                ...
                                                <button class="like ml-3" wire:click="assessAnswer('{{$message['category']}}','{{$message['userQuestion']}}a',1)">
