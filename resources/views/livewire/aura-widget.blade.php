                    ...
                    @if($widgetSettings['display_login_form'] == true)
                        <div class="d-flex justify-content-end mb-4">
                            <div class="msg_container_send msg_container_send_theme_{{$widgetSettings['theme']}}">
                                <label>
                                    Login (idUFFS):
                                    <input wire:model="username" wire:keydown.enter="performLogin" type="text" class="form-control type_msg" placeholder="Username">
                                </label>
                                <br>
                                <label>
                                    Senha:
                                    <input wire:model="password" type="password" wire:keydown.enter="performLogin" class="form-control type_msg" placeholder="Senha">
                                </label>
